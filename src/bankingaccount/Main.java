...
//        System.out.println("Amount of \{amount} has been deposited.");
    ...
    @Override
    void showBalance() {
        System.out.println("Balance:"+super.amountOfCash);
    }
    ...
    public void showInDollar() {
        System.out.println("Balance in Dollar:"+super.amountOfCash);
    }

    @Override
    public void showInRiel() {
        System.out.println("Balance in Riel: "+super.riel);
    }
}
class CreditCardAccount extends Account{
    ...
    void showBalance() {
        System.out.print("Insert password: ");
        if(password==new Scanner(System.in).nextInt()){
            System.out.println("Balance: "+amountOfCash);
        }
    }
}
